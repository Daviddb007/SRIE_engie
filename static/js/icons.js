/* ========================================
   STONELYTICS — SVG Icon System
   Replaces Tabler Icons CDN with inline SVGs
   ======================================== */
...
const ICONS = {
  ...
  'dashboard': '<path d="M10 13a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"/><path d="M13.45 11.55l2.05 -2.05"/><path d="M6.4 20a9 9 0 1 1 11.2 0l-11.2 0"/>',
  'database': '<path d="M4 6a8 3 0 1 0 16 0a8 3 0 1 0 -16 0"/><path d="M4 6v6a8 3 0 0 0 16 0v-6"/><path d="M4 12v6a8 3 0 0 0 16 0v-6"/>',
  'device-mobile-off': '<path d="M7.159 3.185c.256 -.119 .54 -.185 .841 -.185h8a2 2 0 0 1 2 2v9m0 4v1a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2v-13"/><path d="M11 4h2"/><path d="M3 3l18 18"/><path d="M12 17v.01"/>',
  ...
  'layout-dashboard': '<path d="M4 5a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1l0 -4"/><path d="M14 5a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1l0 -4"/><path d="M4 15a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1l0 -4"/><path d="M14 15a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1l0 -4"/>',
  'layout-grid': '<path d="M5 4h4a1 1 0 0 1 1 1v6a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1v-6a1 1 0 0 1 1 -1"/><path d="M5 16h4a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1v-2a1 1 0 0 1 1 -1"/><path d="M15 12h4a1 1 0 0 1 1 1v6a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1v-6a1 1 0 0 1 1 -1"/><path d="M15 4h4a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1v-2a1 1 0 0 1 1 -1"/>',
  ...
  'lock-off': '<path d="M15 11h2a2 2 0 0 1 2 2v2m0 4a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-6a2 2 0 0 1 2 -2h4"/><path d="M11 16a1 1 0 1 0 2 0a1 1 0 0 0 -2 0"/><path d="M8 11v-3m.719 -3.289a4 4 0 0 1 7.281 2.289v4"/><path d="M3 3l18 18"/>',
  ...
  'message-chatbot': '<path d="M18 4a3 3 0 0 1 3 3v8a3 3 0 0 1 -3 3h-5l-5 3v-3h-2a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3h12"/><path d="M9.5 9h.01"/><path d="M14.5 9h.01"/><path d="M9.5 13a3.5 3.5 0 0 0 5 0"/>',
  ...
  'pencil-ruler': '<path d="M5 19m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"/><path d="M15 4l4 4l-10 10h-4v-4z"/><path d="M14.5 5.5l5 -5"/><path d="M6.5 12.5l5 -5"/>',
...
function replaceIconsWithSVG() {
  document.querySelectorAll('[class*="ti ti-"]').forEach(el => {
    const classes = Array.from(el.classList);
    const iconClass = classes.find(c => c.startsWith('ti ti-'));
    if (!iconClass) return;

    const iconName = iconClass.replace('ti ti-', '');
    if (!ICONS[iconName]) return;

    const computedSize = window.getComputedStyle(el).fontSize;
    const svg = createSVGIcon(iconName, computedSize);

    Array.from(el.attributes).forEach(attr => {
      if (attr.name !== 'class') svg.setAttribute(attr.name, attr.value);
    });
    svg.setAttribute('class', el.className.replace(/ti ti-\S+/g, '').trim());
